...
const formState = reactive({
    ...
    prices: {
        ...
        cache_write_5m: undefined as number | undefined,
        cache_write_1h: undefined as number | undefined,
...
function openEdit(model: Model) {
    ...
    formState.prices = {
        ...
        cache_write_5m: model.prices?.cache_write_5m ?? undefined,
        cache_write_1h: model.prices?.cache_write_1h ?? undefined,
